...
import com.mycelia.stem.control.commands.Command;
...
public class ReflectionCommand {
	...
	public ReflectionCommand(Class<com.mycelia.stem.control.commands.Command> current, String command, Method ... methods){
		this.c = current;
